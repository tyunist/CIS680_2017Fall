...
parser.add_argument('--part', default='2.1', type=str, help='part which you want to run (2/3)', choices=['2.1', '2.2'])
...
parser.add_argument('--loss_type', default='cls', type=str, help='Type of loss functions', choices=['cls', 'reg', 'object', 'proposal', 'simple'])
...
# Logfile
args.model = os.path.join(args.model, args.part) 
