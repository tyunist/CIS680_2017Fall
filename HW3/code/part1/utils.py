...
def de_norm(image):
  #mean  = (125.92819585, 123.48458521, 114.44250273)
  #std   = ( 63.02008937,   62.1541447,  66.83732566)  
  mean  = (0.4914, 0.4822, 0.4465)
  std =  (0.247, 0.243, 0.261)
  print('===> Size of image:', image.shape)
  if len(image.shape) == 4:
    for i in range(3):
      print('====> Channel %d, mean %.3f'%(i+1,np.mean(image[:,:,:,i])))
...
def batch_display(sample_batched):
  ...
  plt.imshow(de_norm(grid.numpy().transpose((1,2,0))))
